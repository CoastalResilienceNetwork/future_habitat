           ...
           return declare(PluginBase, {
			   ...
			   changeGeography: function(geography, zoomto, sindex, shapedata) {
					...
					array.forEach(geography.variables, lang.hitch(this,function(svar, i){
					  ...
					  nslidernodetitle = domConstruct.create("div", {innerHTML: thelpButton + " <b>" + svar.name +"</b>", style: "padding-top:15px"});
...
*/			   
			   ...
			   applyFilter: function() {
					...
					//console.log("%%%%%%%%%%%%%%%%%%%%%",  this.clippingGeometry);
			   ...
			   updateMap: function() {
				...
				render: function() {
					...
					this.buttonpane = new ContentPane({
					  style:"border-top-style:groove !important; height:120px;overflow: hidden !important;background-color:#F3F3F3 !important;padding:10px !important; display: none"
					});
